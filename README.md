...
A measurement example is found in [ansibleplaybook-time-measurement](https://github.com/Ravi1708/sw-go-ansible/blob/master/examples/ansibleplaybook-time-measurement/ansibleplaybook-time-measurement.go).
